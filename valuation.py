...
from.product import (Tolling, EXERCISE_BLOCK, EXERCISE_DAILY, EXERCISE_HOURLY, EXERCISE_BLOCK)
...
class Valuation(object):
    ...
    **kwargs:
    ...
    def _rng_periods(self):
        ...
        rng_periods = ((self.feasible_peridos,) if active_periods
